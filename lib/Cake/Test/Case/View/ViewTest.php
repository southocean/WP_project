 ...
 */
	public function testGetTemplate() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'index_question.ctp';
 ...
 */
	public function testPluginGetTemplate() {
		...
		$expected = CakePlugin::path('TestPlugin') . 'View' . DS . 'Tests' . DS . 'index_question.ctp';
 ...
 */
	public function testPluginThemedGetTemplate() {
		...
		$ThemeView = new TestThemeView($this->Controller);
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'Tests' . DS . 'index_question.ctp';
 ...
 */
	public function testCamelCasePluginGetTemplate() {
		...
		$pluginPath = CakePlugin::path('TestPlugin');
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'View' . DS . 'Tests' . DS . 'index_question.ctp';
		$result = $View->getViewFileName('index');
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Posts' . DS . 'index_question.ctp';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('index');
		$this->assertRegExp('/Posts(\/|\\\)index_question.ctp/', $result);
		...
		$this->assertRegExp('/Themed(\/|\\\)TestTheme(\/|\\\)Posts(\/|\\\)index_question.ctp/', $result);
